...
class BaseActuatorSimTask():
	"""
		...
		Provides default implementations for common methods and enforces
		implementation of others via subclassing.

		Attributes:
		name: The name of the actuator.
		typeID: The type ID of the actuator.
		simpleName: A simplified name for the actuator.
		lastKnownCommand: The last command received by the actuator.
		lastKnownValue: The last value received by the actuator.
		lastKnownState: The last state data received by the actuator.	
	"""
